package xyz.nextcloudcleaner.ui
...
import xyz.nextcloudcleaner.vm.LoginState
...
fun LoginScreen(
    ...
    Column(
        ...
        Text("Nextcloud Cleaner", style = MaterialTheme.typography.headlineMedium)
        ...
        Spacer(Modifier.height(24.dp))
        Text(
            "Your server needs the Nextcloud Cleaner app installed and enabled.",
            style = MaterialTheme.typography.bodySmall,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
        )
    }
