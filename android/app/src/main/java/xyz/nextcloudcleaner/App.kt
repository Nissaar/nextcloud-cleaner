...
import xyz.nextcloudcleaner.api.LoginFlow
import xyz.nextcloudcleaner.api.NextcloudCleanerApi
import xyz.nextcloudcleaner.data.AccountStore
import xyz.nextcloudcleaner.data.Repository
import xyz.nextcloudcleaner.data.Settings
import xyz.nextcloudcleaner.data.VerdictOutbox
import java.io.File
...
object Graph {
    ...
    lateinit var settings: Settings
        private set
    lateinit var api: NextcloudCleanerApi
        private set
    ...
    fun open(application: Application) {
        ...
        api = NextcloudCleanerApi(http) { accounts.current() }
