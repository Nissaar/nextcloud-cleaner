...
import xyz.photocleaner.nextcloud.api.LoginFlow
import xyz.photocleaner.nextcloud.api.PhotoCleanerApi
import xyz.photocleaner.nextcloud.data.AccountStore
import xyz.photocleaner.nextcloud.data.Repository
import xyz.photocleaner.nextcloud.data.Settings
import xyz.photocleaner.nextcloud.data.VerdictOutbox
import java.io.File
...
object Graph {
    ...
    lateinit var settings: Settings
        private set
    lateinit var api: PhotoCleanerApi
        private set
    ...
    fun open(application: Application) {
        ...
        api = PhotoCleanerApi(http) { accounts.current() }
