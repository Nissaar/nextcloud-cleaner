...
import xyz.photocleaner.nextcloud.vm.LoginState
...
fun LoginScreen(
    ...
    Column(
        ...
        Text("Photo Cleaner", style = MaterialTheme.typography.headlineMedium)
        ...
        Spacer(Modifier.height(24.dp))
        Text(
            "Your server needs the Photo Cleaner app installed and enabled.",
            style = MaterialTheme.typography.bodySmall,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
        )
    }
